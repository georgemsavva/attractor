...
col <- hsv(runif(N),runif(N,0,.6),1, alpha = .3)
png(sprintf("pngs/nbody_4_%05d.png",l), width=3000, height=3000, type="cairo")
par(bg="black")
...
for(i in 1:10000){
  ...
  if(i>0000) points(pos[,1]-pos[1,1],pos[,2]-pos[1,2], col=col, pch=20, cex=c(40,sqrt(mass[-1])*2))
}
text(-4.3,-4.9, labels = paste0("Star system 3\nSeed = ",seed), cex=4, col="white")
dev.off()
print(l)
#shell("nbody.png")
}